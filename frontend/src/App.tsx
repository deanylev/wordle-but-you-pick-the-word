      ...
      <BrowserRouter>
        <div className="App">
          <div className="header">
            <button onClick={() => this.setState({ showSideNav: !showSideNav })} onMouseDown={(event) => event.preventDefault()}>
            ...
            <button onClick={() => this.setState({ showSettings: true })} onMouseDown={(event) => event.preventDefault()}>
